...
<div id="msginsert"></div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="text-white btn btn-warning btn-sm" data-toggle="modal"
                                                data-target="#vendor_{{$customer->vendor_id}}">Add</button>
                                            <!-- Modal -->
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (data.code == "404") {
                        ...
                        $('#msginsert').html('<div class="alert alert-success"Vendor Deleted successfully!.</div>');
                        //  location.reload();
                    }
                    location.reload();
                    // LoadData();
    ...
    $(document).ready(function(){
        ...
        function fetch_data(search="",dates="",from_date="",to_date="") {
            $.ajax({
            url:ENDPOINT+"/vendor_list_ajax?search="+search+"&dates="+dates+"&from_date="+from_date+"&to_date="+to_date,
        ...
        $.ajax({
            ...
            success:function(data)
            {
                if (data.code == "404") {
                    ...
                    $('#msginsert').html('<div class="alert alert-success">Commission added successfully!.</div>');
                     location.reload();
                }
