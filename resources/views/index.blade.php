...
@section('main-container')
        ...
        <div class="main-panel">
          <div class="content-wrapper bg-white">
            <div class="row">
              <div class="col-sm-4">
                <div class="h-100 card bglightb">
                
                   
                        <div class="card-body caseitem">
                            <h3 class="card-title "> Total Sale <small class="text-gray">(In Month)</small></h3>
                            ...
                            <!-- <span class="float-right display-5 opacity-5">
                                <img width="60" src="{{-- asset('icons/flaticon-icon') --}}/{{-- $value->thumbnail --}}" class="mr-3"/>
                            </span> -->
                        </div>
              ...
              <div class="col-sm-4">
                <div class="h-100 card bglightred ">
                   
                        <div class="card-body caseitem1">
                       
                            <h3 class="card-title textrcolor">Total Expanse<small class="text-gray">(In Month)</small></h3>
                            <div class="d-inline-block">
                                <h2 class="textrcolor">
                                {{--$total_expance->count()--}}
                                <?php $total=0; ?>
                                @foreach($total_expance as $expance)
                                <?php $total+=$expance->expenses_amount; ?>
                                @endforeach
                                {{$total}}
                                </h2>
                                <!-- <p class="text-white mb-0">Jan - March 2019</p> -->
              ...
              <div class="col-sm-4">
                <div class="h-100 card bglightgreen ">
                   
                        <div class="card-body caseitem2">
                        <a href="{{url('order_list')}}" aria-expanded="false"> 
                            <h3 class="card-title textgcolor">Total Orders <small class="text-gray">(In Month)</small></h3> </a>
                            <div class="d-inline-block">
                                <h2 class="textgcolor">
                                {{$total_orders->count()}}
                                </h2>
              ...
              <!-- <div class="col-sm-3">
                <div class="h-100 card bglightp">
                    
                        <div class="card-body caseitem3">
                            <h3 class="card-title textpcolor">Menus</h3>
                            <div class="d-inline-block">
                                <h2 class="textpcolor">
              ...
              <!-- <div class="col-sm-3">
                <div class="card bg-info  ">
                        ...
                        <div class="card-body">
                            <h3 class="card-title text-white">Total Expence</h3>
                            <div class="d-inline-block">
                                <h2 class="text-white">
                            ...
                            <span class="float-right text-white">
                              <a href="{{url('add_expenses')}}"> Add Expence
                            </a>
                          </span>
                        </div>
            ...
            <div class="row mt-md-5">
              ...
              <a href="{{url('add_expenses')}}" class="btn btn-primary btn-lg btn-block "> 
              <i class="typcn typcn-chart-pie-outline menu-icon"></i>  
              Add Expenses </a>
              </div>
              <div class="col-12 col-md-3">
              <a href="{{url('order')}}" class="btn btn-success btn-lg btn-block ">
            ...
            <!-- <div class="row">
              ...
              <div class="col-sm-4">
                <div class="card bg-light  ">
                    <a href="{{--url('event_category?category_id='.$value->id)--}}" aria-expanded="false"> 
                        <div class="card-body">
                      ...
                      <table class="table">
                        <tbody>
                          <tr>
                            <td>
                              <div class="d-flex">
                                <img class="img-sm rounded-circle mb-md-0 mr-2" src="{{asset('web/')}}/images/faces/face30.png" alt="profile image">
                                <div>
                                  <div> Company</div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex">
                                <img class="img-sm rounded-circle mb-md-0 mr-2" src="{{asset('web/')}}/images/faces/face31.png" alt="profile image">
                                <div>
                                  <div> Company</div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex">
                                <img class="img-sm rounded-circle mb-md-0 mr-2" src="{{asset('web/')}}/images/faces/face32.png" alt="profile image">
                                <div>
                                  <div> Company</div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex">
                                <img class="img-sm rounded-circle mb-md-0 mr-2" src="{{asset('web/')}}/images/faces/face33.png" alt="profile image">
                                <div>
                                  <div> Company</div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex">
                                <img class="img-sm rounded-circle mb-md-0 mr-2" src="{{asset('web/')}}/images/faces/face34.png" alt="profile image">
                                <div>
                                  <div> Company</div>
                                  <div class="font-weight-bold  mt-1">volkswagen</div>
                                </div>
